  ...
  const newArrivals = [
    {
      ...
      price: "1,625.00",
      image: "https://res.cloudinary.com/dwlaojqop/image/upload/1_cdo2tx.webp",
    ...
    },
    {
      ...
      price: "1,625.00",
      image: "https://res.cloudinary.com/dwlaojqop/image/upload/2_f1amvt.webp",
    ...
    },
    {
      ...
      price: "1,625.00",
      image: "https://res.cloudinary.com/dwlaojqop/image/upload/3_yctien.webp",
    ...
    },
    {
      ...
      price: "1,690.00",
      image: "https://res.cloudinary.com/dwlaojqop/image/upload/4_oc8b5f.webp",
  ...
  return (
    <main className="min-h-screen ">
      ...
      <section className="py-8 md:py-12 px-4 ">
        ...
        <div className="py-3 text-right"><a href="http://shop.etherealbd.com/" className="underline">View more </a></div>
      </section>

      {/* Title Event Section */}
      <section className="grid grid-cols-1 md:grid-cols-2 mb-8 md:mb-16 m-4">
          <Image
            src="https://res.cloudinary.com/dwlaojqop/image/upload/event_ggdjpl.webp"
            alt="The Ethereal"
            width={600}
            height={800}
            className="w-full h-auto"
          />
        <div className=" py-6 md:py-12  md:pl-12 flex flex-col justify-center">
